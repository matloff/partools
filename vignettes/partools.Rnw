...
Scala, they are difficult to install, configure and use for those
...
tolerance to be an issue for many Hadoop/Snow users, who do not have
such large systems.\footnote{https://wiki.apache.org/hadoop/PoweredBy}
on other systems.
